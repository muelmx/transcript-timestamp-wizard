...
export class FileName {
  ...
  public static fromString(unsafe: string) {
    let safe = unsafe.trim();
...
export class InputFile {
  ...
  public static forFile(name: FileName, content: InputFileContent) {
...
export class OutputFile {
  ...
  public static forContent(inputFile: InputFile, content: OutputFileContent) {
