import { InputFileContent, OutputFileContent } from '../domain/files';

export const TestData = {
  input: InputFileContent.fromString(`
00:00:02:17 - 00:00:23:03
Sprecher 1
...
Und das ist der Anfang. Möchte ich etwas über Sie erfahren. Wer sind Sie und welche Funktion haben Sie an Ihrer Schule?
    `),
  output: OutputFileContent.fromString(`
00:00:02.17 Ja, da möchte ich mich erst mal ganz herzlich bei Ihnen bedanken, dass Sie sich die Zeit nehmen wollte, mit mir über das Thema Digitalisierung zu sprechen. Wir werden mit verschiedenen Themenbereiche abgreifen. Wir werden über das Thema digitale Infrastruktur, den Einsatz von digitalen Medien und das Medium bezogene professionell Wissen sprechen und eben den Medien Einsatz speziell in Bezug auf ihre Schülerinnen schaft.
